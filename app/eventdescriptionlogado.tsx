...
const styles = StyleSheet.create({
  ...
  eventImage: { width: '100%', height: 350, backgroundColor: '#ccc' },
  gradient: { position: 'absolute', left: 0, right: 0, top: 200, height: 150 },
  contentContainer: { padding: 20, backgroundColor: '#f4f4f8' },
  eventName: { fontSize: 28, fontWeight: 'bold', color: '#333', marginBottom: 15, marginTop: -50 },
  infoRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
  infoText: { fontSize: 16, color: '#555', marginLeft: 10 },
  eventDescription: { fontSize: 16, color: '#444', lineHeight: 24, marginTop: 20 },
  ticketsSection: { marginTop: 30, borderTopWidth: 1, borderTopColor: '#e0e0e0', paddingTop: 20 },
  sectionTitle: { fontSize: 22, fontWeight: 'bold', color: '#333', marginBottom: 15 },
  ticketTypeRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 15, borderBottomWidth: 1, borderBottomColor: '#e0e0e0' },
  ticketDetails: { flex: 1 },
  ticketTypeName: { fontSize: 18, color: '#333', fontWeight: '600' },
  ticketTypePrice: { fontSize: 14, color: '#777', marginTop: 4 },
  quantitySelector: { flexDirection: 'row', alignItems: 'center' },
  quantityButton: { backgroundColor: '#e8e8e8', width: 36, height: 36, borderRadius: 18, justifyContent: 'center', alignItems: 'center' },
  quantityButtonText: { color: '#333', fontSize: 20, fontWeight: 'bold' },
  quantityText: { fontSize: 20, color: '#333', fontWeight: 'bold', marginHorizontal: 20, minWidth: 30, textAlign: 'center' },
  footer: { position: 'absolute', bottom: 0, left: 0, right: 0, padding: 20, paddingBottom: 30, backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#ddd', shadowColor: '#000', shadowOffset: { width: 0, height: -2 }, shadowOpacity: 0.1, shadowRadius: 5, elevation: 10 },
  totalPriceContainer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 15 },
  totalPriceLabel: { fontSize: 18, color: '#555', fontWeight: '500' },
  totalPriceValue: { fontSize: 22, color: '#333', fontWeight: 'bold' },
  buyButton: { backgroundColor: '#667eea', paddingVertical: 15, borderRadius: 10, alignItems: 'center', justifyContent: 'center', minHeight: 50 },
